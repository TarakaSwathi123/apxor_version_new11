var scale_multiplier = window.devicePixelRatio;
...
function getBounds(e, t, o) {
  ...
  return (
    "{'left':" +
    (Math.round(n.left * scale_multiplier) + t) +
    ",'top':" +
    (Math.round(n.top * scale_multiplier) + o) +
    ",'right':" +
    (Math.round(n.right * scale_multiplier) + t) +
    ",'bottom':" +
    (Math.round(n.bottom * scale_multiplier) + o) +
    "}"
  );
}
...
function getViewHierarchy(e, t, o, q, b, n, r, a) {
  console.log(e, t, o, q, b, n, r, a);

  var i = getBounds(e, t, o),
      d = cssPath(e, !1),
      N = xPath(e, !1, r),
      fullCssPath = cssPath(e, !0),
      content = e.innerText.trim() || "", // Get element's content (text)
      u = {
        id: d,
        bounds: i,
        view: e.tagName,
        ...
        content: content // Add content to the hierarchy
      },
      s = e.children;

  console.log(content); // Log element's content
...
function getViews(e, t, o = "", s = "android", scale = window.devicePixelRatio) {
