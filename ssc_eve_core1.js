(function (global, factory) {
  ...
  var SURVEY_COMPLETED_LIST = "apx_survey_list";
  ...
  var Sync = /*#__PURE__*/_createClass(function Sync() {
    ...
    _defineProperty(this, "_validateHashes", function (response, type, apiUrl, data, callback) {
      ...
      var surveyCompletedList = JSON.parse(Controller.getInstance().getFromStorage(SURVEY_COMPLETED_LIST));
      var updatedConfigs = [];
      if (drop.length > 0 || pull.length > 0) {
        ...
        pull.forEach(function (id) {
          ...
          if (surveyCompletedList !== null && surveyCompletedList.some(function (el) {
            return el.id === id;
          })) {
            surveyCompletedList = surveyCompletedList.filter(function (el) {
              return el.id !== id;
            });
            Controller.getInstance().persistToStorage(SURVEY_COMPLETED_LIST, JSON.stringify(surveyCompletedList));
          }
        });
    ...
    _defineProperty(this, "_fetchConfig", function (type, apiUrl, existingConfigs, callback) {
      Controller.getInstance().makeGetRequest(apiUrl, function (response) {
        ...
        response.configs.forEach(function (config) {
          var _config$meta, _config$meta2, _config$meta3, _config$meta4, _Controller$getInstan;
          var eventProps = {
          ...
          if (type === _this._SURVEYS) {
            var _config$meta5;
            eventProps.apx_survey_name = config === null || config === void 0 || (_config$meta5 = config.meta) === null || _config$meta5 === void 0 ? void 0 : _config$meta5.name;
            eventProps.apx_survey_id = config === null || config === void 0 ? void 0 : config._id;
          }
          var apx_nudge_type = type === _this._SURVEYS ? "survey" : "campaign";
          (_Controller$getInstan = Controller.getInstance()) === null || _Controller$getInstan === void 0 || _Controller$getInstan.logAppEvent("apx_config_received", eventProps, undefined, false, "apxor", apx_nudge_type);
        });
